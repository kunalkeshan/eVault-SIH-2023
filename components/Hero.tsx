				...
				<section className='flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row'>
					...
					<div className='flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24 xl:ml-8'>
						...
						<p className='mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg'>
							Secure Legal Records Management with Blockchain
							Technology - Scalable and Integrated Solution
						</p>
					...
					<div className='grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16'>
						...
						<div className='flex gap-4 md:gap-6'>
							...
							<div>
								...
								<p className='mb-2 text-gray-500'>
									Legal Ledger uses decentralization to ensure
									that your legal records are secure and
									accessible from multiple locations, reducing
						...
						<div className='flex gap-4 md:gap-6'>
							...
							<div>
								...
								<p className='mb-2 text-gray-500'>
									With Legal Ledger, your legal documents are
									stored in an unalterable state, guaranteeing
						...
						<div className='flex gap-4 md:gap-6'>
							...
							<div>
								...
								<p className='mb-2 text-gray-500'>
									Legal Ledger prioritizes top-tier security
									measures, including encryption and
									authentication, to protect your sensitive
									legal records from unauthorized access.
								</p>
								<a
									href='#'
									className='font-bold text-blue-500 transition duration-100 hover:text-blue-600 active:text-blue-700'
