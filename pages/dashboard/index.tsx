        ...
        <div className="max-h-[60vh] overflow-y-auto w-[95vw] md:w-[65vw] border-2 border-neutral-500 mx-auto my-12">
             <Table>
                ...
                {records.map((record) => (
                    ...
                    <TableCell className="text-center">{record.description}</TableCell>
                    <TableCell className="text-center"><Link href={record.image} className="px-4 py-2 bg-blue-600 text-white rounded-xl">View</Link></TableCell>
                    </TableRow>
                ))}
                </TableBody>
            </Table>
