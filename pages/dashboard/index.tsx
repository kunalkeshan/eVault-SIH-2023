	...
	const [records, setRecords] = useState([
		{
			...
			image: 'ipfs://bafyreigyzzxhm7impvpaz4refpreefukuc7biuahrpijghqe5yv3eruc2u/metadata.json',
		},
		{
			name: 'Case Law Summary EU',
			description: 'summary for EU case law ',
			image: 'ipfs://bafyreihntszzbtghpvlrpiudj5rmqufm3ofy44ndnwzponrpdiuaff2awy/metadata.json',
		},
		{
			name: 'Non Disclosure Agreement',
			description: 'NDA appeal',
			image: 'ipfs://bafyreifxuq6vb7u5fxt7fa5kp2ak6pftygmabms5a5wc5efj47cam2veoe/metadata.json',
		},
	]);
		...
		if (typeof window !== 'undefined') {
			if (localStorage.getItem('ipfs')) {
				...
				updated.push({
					...
					image: localStorage.getItem('ipfs') || '',
				});
				setRecords(updated);
			}
		}
